...
try:
    cursor.executemany(
        'INSERT INTO student_subjects (Enrollment, Subject, Mark) VALUES (?, ?, ?)',
        student_subjects
    )
except sqlite3.IntegrityError:
...
cursor.execute('''SELECT students.Enrollment, students.name, 
student_subjects.Subject, student_subjects.Mark 
FROM students  
